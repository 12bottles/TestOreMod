package com.twelvebottles.neworemod.item.custom;

import com.google.common.collect.ImmutableMap;
import com.twelvebottles.neworemod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.SABLONIUM_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.SLOW_FALLING, 200, 1, false, false),
